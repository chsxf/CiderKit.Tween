...
public extension String {
    ...
    static func tween(_ travel: TweenDetailedTravel<String>, duration: TimeInterval, scramble: Bool = false, scrambleCharacters: String? = nil, easing: Easing = Easing.linear, manualUpdate: Bool = false, loopingType: LoopingType = .none) async -> Tween<String> {
